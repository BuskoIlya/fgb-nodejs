...
const NationalTeamGameController = require('./src/db/controllers/NationalTeamGameController');
const NewsController = require('./src/db/controllers/NewsController');
...
app.get(process.env.API_NEWS, NewsController.getAllNews);
app.get(process.env.API_NATIONAL_TEAM_GAME, NationalTeamGameController.getFullTeamGameDataById);
app.get(process.env.API_NATIONAL_TEAM_GAMES, NationalTeamGameController.getAllNationalTeamGames);
app.get(process.env.API_NATIONAL_TEAM_GAMES_BY_YEAR, NationalTeamGameController.getNationalTeamGamesByYear);
